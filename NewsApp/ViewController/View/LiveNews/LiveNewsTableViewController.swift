//
//  LiveNewsTableViewController.swift
//  NewsApp
//
...
class LiveNewsTableViewController: UITableViewController {

    private  let data = [
       PopularModel(nameNews: "Песков ответил на оскорбления министра обороны Британии в адрес Путина", imageNews: "lock", dateNews: "today"),
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameNewsLable.text = dat.dateNews
